...
<?php if (have_posts()): ?>
    <?php while (have_posts()):
        ...
        $product_description = get_field('products-description');
            ...
            <div class="frontpage-container">
                <section id="hero-section">
                    ...
                    <div class="hero-visuals">
                        ...
                        <svg id="scroll-arrow" width="30" height="30" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <section id="about-section">
                    ...
                    <div class="recipes-text">
                        ...
                        <button class="recipes-btn frontpage-button"><a href="<?php echo get_permalink( get_page_by_path('opskrifter') ); ?>">Opskrifter</a></button>
                    </div>
