            ...
            <div class="frontpage-container">
                <section id="hero-section">
                    ...
                    <div class="hero-visuals">
                        ...
                        <svg id="scroll-arrow" width="30" height="30" viewBox="0 0 24 24" fill="white"
                ...
                <section id="products-section">
                    ...
                    <button class="all-products-btn frontpage-button"><a
                            href="<?php echo get_permalink(get_page_by_path('shop')); ?>">Alle produkter</a></button>
                </section>
